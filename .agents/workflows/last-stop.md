---
description: description: A ruthless quality gate that finds and safely fixes in-scope issues, adds tests and evidence, verifies changes, and re-reviews for regressions. It only stops for real product decisions, missing access, or risky irreversible actions.
---
